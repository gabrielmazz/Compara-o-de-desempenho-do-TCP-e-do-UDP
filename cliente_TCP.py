...
try:
    ...
    cliente_tcp.connect((endereco_servidor, porta_servidor))
...
cliente_tcp.send(NOME_ARQUIVO.encode("utf-8"))

# Inicia a transferência do arquivo com pacotes de tamanho variado
with open(NOME_ARQUIVO, 'rb') as arquivo:
    # ler o arquivo em pedaços de tamanho variado
    while True:
...
print("Arquivo enviado com sucesso via TCP!\n")
